...
COLUMNS: list[tuple[str, str, str]] = [
    ...
    ("MIN_STOCK_UPDATE", "Min Stock Update", "Chỉ thực sự cập nhật Stock lên Eldorado khi stock ĐANG LIVE trên listing xuống DƯỚI số này — còn >= số này thì coi là đủ, bỏ qua update stock (Price/MinQty vẫn tính bình thường, không bị ảnh hưởng). Để TRỐNG = giữ hành vi cũ, luôn đồng bộ Stock mỗi khi khác giá trị đang live."),
